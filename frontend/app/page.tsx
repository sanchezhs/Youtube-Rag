      ...
      <div className="p-6 space-y-6">
            ...
            <Card className="hover:shadow-md transition-shadow cursor-pointer">
              <CardContent className="p-4 flex items-center gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-gray-500">Add/remove channels</p>
                </div>
            ...
            <Card className="hover:shadow-md transition-shadow cursor-pointer">
              <CardContent className="p-4 flex items-center gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-gray-500">View all videos</p>
                </div>
                <ArrowRight className="h-5 w-5 text-gray-400" />
              </CardContent>
            </Card>
          ...
          <Link href="/pipeline">
            <Card className="hover:shadow-md transition-shadow cursor-pointer">
              <CardContent className="p-4 flex items-center gap-4">
                ...
                <div className="flex-1">
                  <p className="font-medium text-gray-900">Run Pipeline</p>
                  <p className="text-sm text-gray-500">Start ingestion</p>
                </div>
                <ArrowRight className="h-5 w-5 text-gray-400" />
              </CardContent>
            </Card>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <Card>
            <CardHeader>
              <div className="flex items-center justify-between">
                <h3 className="font-semibold text-gray-900">Recent Channels</h3>
                <Link href="/channels" className="text-sm text-primary-600 hover:text-primary-700">
                  View all
                </Link>
              </div>
            </CardHeader>
          ...
          <Card>
            <CardHeader>
              <div className="flex items-center justify-between">
                <h3 className="font-semibold text-gray-900">Pending Downloads</h3>
              ...
              {pendingVideos.length === 0 ? (
                ...
                <div className="divide-y divide-gray-200">
                  {pendingVideos.map((video) => (
                    <div key={video.video_id} className="p-4 hover:bg-gray-50">
                      <p className="font-medium text-gray-900 truncate">
                        {video.title || 'Untitled Video'}
                      </p>
                      <p className="text-sm text-gray-500">{video.video_id}</p>
                    </div>
                  ))}
                </div>
              )}
